...
- **Trouver la bonne réponse pour avancer** — QCM, tableau et paires seulement. Après une mauvaise réponse, la correction ne s'affiche pas : le membre recommence jusqu'à trouver, pour ancrer la réponse. **Seule la première tentative compte** — pour la maîtrise, l'XP et le repérage des réponses au hasard ; les suivantes ne servent qu'à retenir. Une réponse écrite, un dessin ou un fichier n'y sont pas soumis : une réponse écrite juste peut ne pas ressembler au texte attendu, et on bloquerait un membre qui a raison. Une fois passée, la question ne revient plus.
