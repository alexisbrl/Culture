        ...
        {locale === 'fr' ? (
          ...
          <div className="prose prose-gray max-w-none space-y-8">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                The Culture website (get-culture.com) is published personally as part of a beta-phase project. Contact information is available via the Contact page.
              </p>
            </div>
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">2. Personal Data</h2>
              <p className="text-gray-600 leading-relaxed">
                Data collected through the waitlist form (first name, email, role) is used solely to contact you regarding the beta program. It is never sold or shared with third parties. Under GDPR, you have the right to access, correct, or delete your data. To exercise these rights: contact@get-culture.com.
              </p>
            </div>
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">3. Cookies</h2>
